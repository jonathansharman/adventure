...
/// The minimum number of frames an archer AI will wait before shooting an
/// arrow.
pub const MIN_ARROW_DELAY: u32 = 150;
/// The maximum number of frames an archer AI will wait before shooting an
/// arrow.
pub const MAX_ARROW_DELAY: u32 = 300;
/// The speed of a launched arrow.
pub const ARROW_SPEED: f32 = 10.0;

/// Speed while moving orthogonally.
pub const ORTHOGONAL_SPEED: f32 = 80.0;
/// Magnitude of x- and y-speed while moving diagonally.
...
/// How bright a character should be during the dim part of the invulnerability
/// blinking animation.
